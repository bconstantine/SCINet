...
data_parser = {
    ...
    'ALL_TEMP': {'data': 'DCL_transform_1025_edited_ALL.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    'July_High_Correlation_Table_TEMP': {'data': 'DCL_transform_1025_edited_July_High_Correlation_Table.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    'ALL_CUT_TEMP': {'data': 'DCL_transform_1025_cut_ALL.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    'July_High_Correlation_Table_CUT_TEMP': {'data': 'DCL_transform_1025_cut_July_High_Correlation_Table.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},

    'ALL_TEMP_WIND': {'data': 'DCL_transform_1101_edited_ALL.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    'July_High_Correlation_Table_TEMP_WIND': {'data': 'DCL_transform_1101_edited_July_High_Correlation_Table.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    'ALL_CUT_TEMP_WIND': {'data': 'DCL_transform_1101_cut_ALL.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    'July_High_Correlation_Table_CUT_TEMP_WIND': {'data': 'DCL_transform_1101_cut_July_High_Correlation_Table.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    ...
    'ALL_TEMP_SEPTEMBER':{'data': 'DCL_transform_1122_cut_ALL_CUT_TEMP_SEPTEMBER.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    'ALL_TEMP_WIND_OCTOBER': {'data': 'DCL_transform_1122_cut_ALL_CUT_TEMP_WIND.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    'ALL_TEMP_WIND_SEPTEMBER':{'data': 'DCL_transform_1122_cut_ALL_CUT_TEMP_WIND_SEPTEMBER.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    'August_High_Correlation_TEMP_SEPTEMBER':{'data':'DCL_transform_1122_cut_August_High_Correlation_September', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    'August_High_Correlation_TEMP_OCTOBER':{'data':'DCL_transform_1122_cut_August_High_Correlation', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    ...
    # 'No_EFA_Day_MonthSinCos': {'data': 'DCL_transform_1008_edited_No_EFA_Day_MonthSinCos.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'July_Important_Variable': {'data': 'DCL_transform_1008_edited_July_Important_Variable.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'July_High_Correlation_Table': {'data': 'DCL_transform_1008_edited_July_High_Correlation_Table.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'ALL_CUT': {'data': 'DCL_transform_1008_cut_ALL.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'No_MonthSinCos_CUT': {'data': 'DCL_transform_1008_cut_No_MonthSinCos.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]}, 
    # 'No_EFA_MonthSinCos_CUT': {'data': 'DCL_transform_1008_cut_No_EFA_MonthSinCos.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'No_EFA_Day_MonthSinCos_CUT': {'data': 'DCL_transform_1008_cut_No_EFA_Day_MonthSinCos.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'July_Important_Variable_CUT': {'data': 'DCL_transform_1008_cut_July_Important_Variable.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'July_High_Correlation_Table_CUT': {'data': 'DCL_transform_1008_cut_July_High_Correlation_Table.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'ALL_July': {'data': 'DCL_transform_1008_edited_ALL_July.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'No_MonthSinCos_July': {'data': 'DCL_transform_1008_edited_No_MonthSinCos_July.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]}, 
    # 'No_EFA_MonthSinCos_July': {'data': 'DCL_transform_1008_edited_No_EFA_MonthSinCos_July.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'No_EFA_Day_MonthSinCos_July': {'data': 'DCL_transform_1008_edited_No_EFA_Day_MonthSinCos_July.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'July_Important_Variable_July': {'data': 'DCL_transform_1008_edited_July_Important_Variable_July.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'July_High_Correlation_Table_July': {'data': 'DCL_transform_1008_edited_July_High_Correlation_Table_July.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'ALL_CUT_July': {'data': 'DCL_transform_1008_cut_ALL_July.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'No_MonthSinCos_CUT_July': {'data': 'DCL_transform_1008_cut_No_MonthSinCos_July.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]}, 
    # 'No_EFA_MonthSinCos_CUT_July': {'data': 'DCL_transform_1008_cut_No_EFA_MonthSinCos_July.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'No_EFA_Day_MonthSinCos_CUT_July': {'data': 'DCL_transform_1008_cut_No_EFA_Day_MonthSinCos_July.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'July_Important_Variable_CUT_July': {'data': 'DCL_transform_1008_cut_July_Important_Variable_July.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
    # 'July_High_Correlation_Table_CUT_July': {'data': 'DCL_transform_1008_cut_July_High_Correlation_Table_July.csv', 'T': 'price', 'M': [7, 7, 7], 'S': [1, 1, 1], 'MS': [7, 7, 1]},
}
...
if args.evaluate:
    setting = '{}_winsize{}_predlen{}_loss{}_pattern{}'.format(args.data,args.seq_len, args.pred_len, args.loss, args.pattern_type)
