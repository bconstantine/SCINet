...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        num_test = 186+(8-(186-self.pred_len+1)%8) #186 - pred len(24) + 1 = 157, since batch size = 157, we add to 183, so that it becomes 160, where 160%8 == 0
        num_vali = 42+(8-(42-self.pred_len+1)%8)
